    ...
    <b-container>
      <b-row class="m-t-10 m-b-10">
        <b-col md="10" offset-md="1">
          ...
          >
            <b-form-textarea id="update-description" type="text" v-model="course.description"></b-form-textarea>
          </b-form-group>
          <b-form-group class="row" label="Trailer" label-cols-md="3" label-for="update-trailer">
            <b-form-input id="update-trailer" v-model="course.trailer" required></b-form-input>
          </b-form-group>
          <b-form-group
            class="row"
            label="Imagen Actual"
          ...
          >
            <div class="text-center">
              <img class="img-course" loading="lazy" :src="'/'+ course.photo" />
            </div>
          </b-form-group>
        ...
        <b-col md="4" offset-md="6">
          <b-row>
            ...
            <b-col col sm="6" md="4" offset-md="1">
              <b-button variant="warning" @click="updateCourse">Modificar</b-button>
            </b-col>
          </b-row>
        </b-col>
      </b-row>
