    ...
    <b-container>
      <b-row class="m-t-10 m-b-10">
        <b-col md="10" offset-md="1">
          <b-form-group class="row" label="Nombre" label-cols-md="3" label-for="course-name">
          ...
          >
            <b-form-textarea id="course-description" type="text" v-model="newCourse.description"></b-form-textarea>
          </b-form-group>
          <b-form-group class="row" label="Trailer" label-cols-md="3" label-for="course-trailer">
            <b-form-input
              id="course-trailer"
          ...
          <b-form-group class="row" label="Categorias" label-cols-md="3" label-for="categories">
            <v-select
              label="name"
              :options="categories"
        ...
        <b-col md="4" offset-md="6">
          <b-row>
            ...
            <b-col col sm="6" md="4" offset-md="1">
              <b-button variant="warning" @click="createcourse">Registrar</b-button>
            </b-col>
          </b-row>
        </b-col>
      </b-row>
