      ...
      <b-row class="m-t-10 m-b-10">
        <b-col md="10" offset-md="1">
          <b-form-group class="row" label="Nombre" label-cols-md="3" label-for="update-name">
            <b-form-input id="update-name" v-model="lesson.name" required></b-form-input>
          </b-form-group>
          <b-form-group
            class="row"
            label="Descripcion"
          ...
          >
            <b-form-textarea id="update-description" type="text" v-model="lesson.description"></b-form-textarea>
          </b-form-group>
        </b-col>
      </b-row>
      <b-row>
        <b-col md="4" offset-md="6">
          <b-row>
            ...
            <b-col col sm="6" md="4" offset-md="1">
              <b-button variant="warning" @click="updateLesson">Modificar</b-button>
            </b-col>
          </b-row>
        </b-col>
      </b-row>
